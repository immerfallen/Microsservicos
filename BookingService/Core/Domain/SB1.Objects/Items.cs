...
namespace Domain.SB1.Objects
{
    public class Items
    {
        ...
        public List<Itemlocalizationinfo> ItemLocalizationInfos { get; set; }
        //public string[] ItemProjects { get; set; }
        //public string[] ItemDistributionRules { get; set; }
        //public string[] ItemAttributeGroups { get; set; }
        //public string[] ItemDepreciationParameters { get; set; }
        //public string[] ItemPeriodControls { get; set; }
    ...
    public class Itemintrastatextension
    {
        ...
        public double? FactorOfSupplementaryUnit { get; set; }
        public int ImportRegionState { get; set; }
        public int ExportRegionState { get; set; }
    ...
    public class Itemwarehouseinfocollection
    {
        ...
        public string[] ItemCycleCounts { get; set; }
    }
    ...
    public class Itemunitofmeasurementcollection
    {
        ...
        public int Length1Unit { get; set; }
        ...
        public Itemuompackagecollection[] ItemUoMPackageCollection { get; set; }
    }

    public class Itemuompackagecollection
    {
        public string UoMType { get; set; }
        public int UoMEntry { get; set; }
        public int PackageTypeEntry { get; set; }
        public double? Length1 { get; set; }
        public int Length1Unit { get; set; }
        public double? Length2 { get; set; }
        public string Length2Unit { get; set; }
